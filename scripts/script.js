...
repayment.addEventListener('click', () => {
    if (repaycmpSt === 'rgba(0, 0, 0, 0)' || interestcmpSt === 'rgba(0, 0, 0, 0)') {
...
interest.addEventListener('click', () => {
    if (interestcmpSt === 'rgba(0, 0, 0, 0)' || repaycmpSt === 'rgba(0, 0, 0, 0)') {
...
button.addEventListener('click', (e) => {
    ...
    for (let i = 0; i < allInputs.length; i++) {        
        ...
        } else if (i === 0 && (allInputs[0].value < 1 || isNaN(allInputs[0].value))) {
            e.preventDefault();
        ...
        } else if (i === 1 && (allInputs[1].value < 1 || isNaN(allInputs[1].value))) {
            e.preventDefault();
        ...
        } else if (i === 2 && (allInputs[2].value < 0 || isNaN(allInputs[2].value))) {
            e.preventDefault();
